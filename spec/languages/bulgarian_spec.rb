...
describe PragmaticTokenizer do
  context 'Language: Bulgarian (bg)' do
    ...
    it 'tokenizes a string #002' do
      ...
      ).tokenize).to eq(["поставя", "началото", "могъща", "династия", ",", "управлява", "продължение", "150", "г.", "саргон", "надделява", "двубой", "владетеля", "град", "ур", "разширява", "териториите", "държавата", "долното", "течение", "тигър", "ефрат", "."])
    end
    ...
    it 'tokenizes a string #004' do
      ...
      expect(PragmaticTokenizer::Tokenizer.new(text,
        ...
        remove_stop_words: true,
        downcase: false
      ).tokenize).to eq(["Без", "български", "жертви", "Париж", "."])
    end
  end
end